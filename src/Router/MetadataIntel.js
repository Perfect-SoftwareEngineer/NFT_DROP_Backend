...
var {get, getAll, create, update} = require('../Controller/MetadataIntelController');
...
/**
 * @swagger
 * /api/metadata/intel/getAll:
 *   get:
 *     summary: Returns all metadata for intel
 *     responses:
 *       200:
 ...
 *               type: array
 *               items:
 *                 $ref: '#/components/schemas/MetadataIntel'
 */
...
/**
 * @swagger
 * /api/metadata/intel/get/{tokenId}:
 *   get:
 *     summary: Returns metadata by tokenId for intel
 *     responses:
 *       200:
