...
var {get, getAll, create, update} = require('../Controller/MetadataGalaController');
...
/**
 * @swagger
 * /api/metadata/gala/getAll:
 *   get:
 *     summary: Returns all metadata for gala
 *     responses:
 *       200:
 ...
 *               type: array
 *               items:
 *                 $ref: '#/components/schemas/MetadataGala'
 */
...
/**
 * @swagger
 * /api/metadata/gala/get/{tokenId}:
 *   get:
 *     summary: Returns metadata by tokenId for gala
 *     responses:
 *       200:
